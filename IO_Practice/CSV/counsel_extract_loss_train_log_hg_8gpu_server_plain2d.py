...
with open('/Users/admin/PycharmProjects/python_prac/IO_Practice/CSV/hg_car_23d_180k_log.log', 'r') as log_file:
    temp = []
    ...
    with open('hg_car_23d_180k_loss_log', 'w') as loss_file:
