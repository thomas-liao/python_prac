...
with open('def54_training_log.log', 'r') as log_file:
    ...
    #         #
            ...
            line = log_file.readline()
            line = log_file.readline()
            line = log_file.readline()  # class2 all accuracy
            line = line.replace('\n', '')
            line_str = line + ','
            line = log_file.readline()
            line = line.replace('\n', '')
    ...
    with open('val_.csv', 'w') as accur_file:
    ...
    with open('val_0.csv', 'w') as accur_file2:
        name_list_0 = []
        for i in range(36):
    ...
    with open('val_1.csv', 'w') as accur_file2:
        name_list_1 = []
        for i in range(36):
    ...
    with open('val_2.csv', 'w') as accur_file2:
        name_list_2 = []
        for i in range(36):
